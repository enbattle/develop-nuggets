...
- **Quantization is harder**: per-expert calibration produces better results than global calibration, because different experts have different weight distributions. Tools like AWQ and GPTQ now support expert-aware quantization
