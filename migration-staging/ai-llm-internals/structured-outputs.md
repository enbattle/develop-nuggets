...
LLMs generate free-form text. Production systems need structured data. The gap creates a class of reliability bugs that surface at scale: valid JSON on 99.8% of calls, then a malformed response that crashes your parser at 3 AM on the call that mattered.
