...
This matters when migrating between models (a prompt that "fits in 8K context" for one model may not for another), and when reproducing exact context window calculations from another model's documentation.
