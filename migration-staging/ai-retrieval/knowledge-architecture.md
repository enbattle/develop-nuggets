...
|-----------|---------------|----------|
| **Semantic Cache** | Past (query, answer) pairs | Repeated or paraphrased questions |
| **OKF Bundle** | Curated, cross-linked concepts | Stable, structured, authoritative knowledge |
