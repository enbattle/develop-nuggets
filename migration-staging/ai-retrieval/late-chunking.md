...
Standard chunking embeds each text segment independently. The embedding for a chunk has no knowledge of surrounding context — "the company" in paragraph 3 doesn't know who "the company" is from paragraph 1.
