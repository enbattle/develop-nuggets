...
HNSW is not designed for frequent individual mutations:

| Operation | Behavior |
|-----------|----------|
| **Insert** | O(M log n) — batch ingestion is fine |
| **Delete** | Soft-delete; physically removed on segment compaction |
| **Update** | Delete + re-insert the vector |
