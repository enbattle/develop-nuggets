...
Standard prompt engineering tricks (few-shot examples, chain-of-thought instructions) can actually hurt extended thinking by over-constraining the model's internal process. Let the model think freely:
