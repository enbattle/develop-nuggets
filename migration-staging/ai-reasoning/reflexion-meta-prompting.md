...
For the full orchestration loop around agentic retry patterns, see the **Orchestration** node. For how Reflexion relates to agent evaluation, see the **Agent System** node.
