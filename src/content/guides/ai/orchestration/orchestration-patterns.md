Multi-agent systems compose the same way distributed services do — a small set of patterns covers most production architectures, and they keep **routing**, **parallelism**, and **aggregation** as separate concerns.
